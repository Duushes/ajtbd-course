...
const questions: ExamQuestion[] = [
  ...
  {
    question: '9. Каков первый шаг в алгоритме запуска нового продукта?',
    options: [
      'Провести масштабное исследование рынка',
      'Написать техническое задание на MVP',
      'Сформулировать гипотезу о работе клиента',
      'Собрать команду и оценить стоимость разработки',
    ],
    correctIndex: 2,
    explanation: 'Алгоритм запуска начинается с формулировки гипотезы/идеи. Затем: анализ рынка → поиск сегментов и RAT → UX/решенческие интервью → оценка стоимости.',
  },
  {
  ...
  {
    question: '14. Amazon расширился от продажи книг к маркетплейсу товаров, затем к Prime-доставке. Какая это стратегия?',
    options: [
      'Go Deeper — совершенствование ядра продукта',
      'Go Higher — движение к Big Job клиента',
      'Go Wider — расширение на смежные работы',
      'Go Deeper + Go Higher одновременно',
    ],
    correctIndex: 2,
    explanation: 'Go Wider — стратегия расширения на смежные работы (adjacent jobs). Amazon последовательно решал работы, возникающие вокруг ядра: от «купить книгу» к «купить что угодно» и «получить быстрее».',
  },
  {
    question: '15. В ходе 16 интервью выявлено: 60% нанимают Excel для учёта расходов, 25% — записную книжку, 15% — ничего. Какой следующий шаг?',
    options: [
      'Скопировать функции Excel в мобильное приложение',
      'Сегментировать по работам, рассчитать приоритет, проверить RAT',
      'Таргетировать тех, кто ничего не делает — нет конкурента',
      'Сразу разрабатывать продукт для самого большого сегмента',
    ],
    correctIndex: 1,
    explanation: 'По AJTBD, следующий шаг — сегментация по работам, а не по текущим решениям. Нужно понять, КАКУЮ работу люди выполняют через Excel/записную книжку, рассчитать приоритет сегмента и валидировать через RAT.',
  },
];
