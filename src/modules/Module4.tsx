...
export default function Module4() {
  return (
    ...
    >
      ...
      {/* --- Шаги сегментации и Problem Score --- */}
      <motion.div variants={fadeInItem} className="mb-8">
        ...
        <div className="p-4 rounded-xl bg-muted/50 border border-border/50 mb-4">
          <p className="text-sm font-semibold text-foreground mb-2">Problem Score: формула оценки проблемы</p>
          ...
          <p className="text-xs text-muted-foreground text-center mt-2">
            Чем сильнее эмоция и чем чаще возникает проблема -- тем выше балл и тем привлекательнее сегмент.
          </p>
        </div>
        <div className="grid gap-3">
          {[
            ...
            {
              step: '3',
              title: 'Рассчитайте Problem Score для каждого сегмента',
              desc: 'Для каждой проблемы, которую назвали респонденты, оцените среднюю эмоцию (насколько больно, от 1 до 5) и среднюю частоту (как часто возникает, от 1 до 5). Перемножьте их.',
            },
            {
              step: '4',
              title: 'Выберите приоритетный сегмент',
              desc: 'Сегмент с самым высоким Problem Score -- это ваша лучшая возможность. Там самые болезненные и частые проблемы, которые ваш продукт может решить.',
            },
          ].map((s) => (
            <div
              key={s.step}
      ...
      <motion.div variants={fadeInItem} className="mb-10">
        ...
        <p className="text-sm text-muted-foreground leading-relaxed mb-4">
          Когда вы нашли несколько сегментов по Problem Score, возникает вопрос: а что если наши допущения
        ...
        <div className="p-4 rounded-xl bg-accent/5 border border-accent/15">
          <p className="text-sm text-muted-foreground leading-relaxed">
            ...
            сегментах (работа + решение + Problem Score). RAT помогает проверить, верны ли эти гипотезы,
      ...
      <motion.div variants={fadeInItem}>
        ...
        <ScenarioCard
          ...
          context="У вас ограниченный бюджет на запуск. Нужно сфокусироваться на одном сегменте с наивысшим Problem Score."
          options={[
            {
              text: 'Сегмент A: Работа "быстро пообедать, не покидая офис" + решение "хожу в столовую в соседнем здании". Problem Score: эмоция 2 x частота 5 = 10. Рынок большой, но проблема слабо болит.',
              outcome:
                'Не лучший выбор. Несмотря на высокую частоту, эмоция слабая (2 из 5) -- люди не очень страдают от текущего решения. Problem Score 10 означает, что мотивация переключиться на ваш продукт будет низкой.',
              score: 1,
            },
            {
              text: 'Сегмент B: Работа "кормить семью разнообразно и полезно" + решение "готовлю сам по вечерам, устаю". Problem Score: эмоция 4.5 x частота 4 = 18. Рынок средний, готовность платить высокая.',
              outcome:
                'Отличный выбор! Самый высокий Problem Score (18) означает сильную боль и высокую частоту. Эти люди каждый день мучаются с текущим решением и готовы платить за лучшую альтернативу. Именно такой сегмент даёт лучший шанс на успех.',
              score: 3,
            },
            {
              text: 'Сегмент C: Работа "порадовать себя чем-то вкусным" + решение "заказываю из ресторанов через другие приложения". Problem Score: эмоция 2 x частота 2 = 4. Рынок большой, но конкуренция огромная.',
              outcome:
                'Слабый выбор. Problem Score всего 4 -- люди не особенно недовольны текущим решением и используют его не так часто. К тому же, конкуренция с устоявшимися сервисами доставки из ресторанов будет крайне высокой.',
              score: 1,
            },
          ]}
        />
